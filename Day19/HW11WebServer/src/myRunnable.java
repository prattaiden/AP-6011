...
//        try {
//            byte[] datata = client_.getInputStream().readNBytes(2);
//            System.out.println("CHECK");
//            for(int i = 0 ; i < datata.length ; i++)
//            {
//                System.out.println(datata[i]);
//            }
////            System.out.println(client_.getInputStream().readNBytes(2));
