...
public class HTTPoutput {
    ...
    public HTTPoutput(String filename, File file, OutputStream outputStream /*File failFile*/) throws IOException {
        // File exists, send it
        String extension = HTTPInput.getExtension(filename);
